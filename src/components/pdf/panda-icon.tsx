...
export function PandaIcon({ size = 40 }: { size?: number }) {
  return (
    <Svg width={size} height={(size * 230) / 280} viewBox="60 50 280 230">
      <Circle cx="200" cy="170" r="130" fill="#4ade80" opacity={0.15} />
      <Circle cx="200" cy="170" r="110" fill="#4ade80" opacity={0.25} />
      ...
      <Path d="M200 109 Q205 95 210 100" fill="none" stroke="#4ade80" strokeWidth={2} strokeLinecap="round" />
      <G transform="rotate(-30 212 97)">
        <Ellipse cx="212" cy="97" rx="5" ry="3" fill="#4ade80" />
      </G>
    </Svg>
  );
}
