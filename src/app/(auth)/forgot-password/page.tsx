      ...
      <div className="w-full max-w-sm space-y-8">
        ...
        {sent ? (
          <div className="bg-green-50 border border-green-200 rounded-xl p-6 text-center space-y-3">
            ...
            <Link
              href="/login"
              className="inline-flex items-center gap-2 text-sm text-petitsafe-primary hover:underline mt-4"
            >
              <ArrowLeft size={16} />
          ...
          <form onSubmit={handleReset} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full h-12 rounded-xl bg-petitsafe-primary text-white font-medium hover:bg-petitsafe-primary/90 disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center justify-center gap-2"
            >
            ...
            <Link
              href="/login"
              className="flex items-center justify-center gap-2 text-sm text-gray-500 hover:text-petitsafe-primary"
            >
              <ArrowLeft size={16} />
              Retour à la connexion
            </Link>
